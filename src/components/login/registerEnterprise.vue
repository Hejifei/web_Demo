                ...
                <div class="header" style="border-bottom:none;height:63px;width:100%;">
                    <div class="headerwp">
                        ...
                        <span class="pl40 f-30">
                            <router-link to="/login/registerPersonal"><span class="pl40 c-999" style="border-left:2px solid #f0f0f0;">个人注册</span></router-link>
                            <router-link to="/login/registerEnterprise"><span class="pl40">企业注册</span></router-link>
                        </span>
                ...
                <div class="loginbody registerBG registerC" id="box" style="margin:0;width:100%;">
                    <div style="width:1050px;" class="clearfix">
                        ...
                        <div class="fr loginbody-z">
                            <p class="registerTitle">企业注册</p>
                            <div class="chge" style="width:410px"></div>
                            <div class="fixbug" id="fixbug">
                                <div class="">
                                    <form class="login" id="AjaxForm">
                                        <!-- @*<p class="mb20 clearfix">
                                            <span class="registname fl">用户名：</span>
                                            <span class="registlabel fl form-group">
                                                <input type="text" placeholder="请输入用户名" class="form-submit" name="username" id="username" />
                                                <span class="tip"></span>
                                            </span>
                                        </p>*@ -->
                                        <p class="mb20 clearfix">
