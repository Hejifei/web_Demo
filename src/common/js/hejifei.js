...
exports.install = function (Vue, options) {
    ...
    // 专门生成用户指纹的js，他的hash算法你可以自己写，默认选择的是MurmurHash3算法，是redis实现hash的2种算法之一，特点是高性能行运算，低概率碰撞，也是常用的负载均衡算法  
    ...
    const getSID =function(that,newhref) {
        ...
        if(!uuid){
            var fp = new Fingerprint({canvas: true,ie_activex: true,screen_resolution: true,screen_orientation: true});
            uuid = MathRand(10) + '-' + fp.get();
    ...
    //点击链接前验证是否登录
    var login_checkhref =function(_href,that) {
        if (localStorage.uid == null || localStorage.uid == '') {
    ...
    var calUtil = {
        ...
        //获取当前选择的年月
        setMonthAndDay:function(DateInsert){
        ...
        drawCal : function(iYear, iMonth ,signList,repayedList) {
            ...
            htmls.push("<span class='icon-caret-left prevbtn calendar_month_prev'></span>");
            htmls.push("<span class='icon-caret-right nextbtn calendar_month_next'></span>");
    ...
    Vue.prototype.ifRegular=ifRegular;
    Vue.prototype._ajax=_ajax;
    Vue.prototype.getUrl=getUrl;
    Vue.prototype.setCookie=setCookie;
    Vue.prototype.ifnull=ifnull;
    Vue.prototype.AjaxSumbit=AjaxSumbit;
    Vue.prototype.getSID=getSID;
    Vue.prototype.checklogin=checklogin;
    Vue.prototype.login_checkhref=login_checkhref;
    Vue.prototype.countdown=countdown;
    Vue.prototype.settime=settime;
    Vue.prototype.calUtil=calUtil;
    Vue.prototype.createPage=$.fn.createPage;
    Vue.prototype.citySelect=$.fn.citySelect;
